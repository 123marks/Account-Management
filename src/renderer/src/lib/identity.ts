// Small pool of coherent browser identities (UA + matching locale + timezone)
// used to give each isolated profile a distinct, believable fingerprint.
...
/** Pick a coherent identity at random. */
